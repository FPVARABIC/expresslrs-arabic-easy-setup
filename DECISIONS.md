...
| 2026-08-20 | DEC-023 | Supersede DEC-009 for staging, committing, pushing, and opening/updating a Draft PR for the current implementation branches | The owner explicitly authorized GitHub upload and repository work; merge and release remain outside this checkpoint | Current owner authorization; STATUS.md |
| 2026-08-20 | DEC-024 | Continue software construction while physical validation remains deferred | The owner is not ready for hardware tests; this does not block Core, Mock, simulation, UX, documentation, or CI work, but it still blocks hardware/write/support/release claims | STATUS.md; validation levels |
| 2026-08-20 | DEC-025 | Require a preview-bound approval for the new M3 Binding UI | Bind approval to operation/provider/device/Target/catalog/authority and recompute live facts before Synthetic execution; no real authority is admitted | ADR-0011; M3 architecture and acceptance records |
| 2026-08-20 | DEC-026 | Require a provenance-bound approval for the new M4 Firmware Update UI | Bind approval to the exact artifact descriptor, every provenance field, compatibility result, live device facts, Synthetic authority, and verification plan before an in-memory write | ADR-0012; M4 architecture and acceptance records |
| 2026-08-20 | DEC-027 | Use `FPVARABIC/expresslrs-arabic-easy-setup` as the canonical current GitHub repository identity | The GitHub account owner name changed; old owner URLs are historical redirects and new records/PRs use the current canonical owner | STATUS.md; Draft PR #5 |
