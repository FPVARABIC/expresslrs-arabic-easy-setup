...
export const workbenchAr = {
  ...
  "wb.stlink.FLASH_NOT_LOCKED":
    "لم تُبلغ وحدة تحكم الذاكرة عن LOCK بعد كتابة القفل (CR {control}). قد تكون الذاكرة ما زالت مفتوحة؛ لم يُعَد تشغيل النواة في البرنامج الثابت. شغّل الاستعادة.",
  ...
  "wb.ui.bindPhraseReplaceConfirm": "استبدلها",
  "wb.ui.bindPhraseReplaceCancel": "أبقِ ما كتبته",
  ...
  "wb.ui.bindPhraseReveal": "أظهر العبارة",
  "wb.ui.bindPhraseHide": "أخفِ العبارة",
