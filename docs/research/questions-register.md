...
| Q-014 | PARTIAL | What signed manifest/source-bundle design will protect firmware distribution? | Supply-chain and revocation gate | ADR-0014 fixes the wire/trust design and byte gate; ADR-0015 proves bounded parsing and untrusted Synthetic verification. Root ceremony, rollback/revocation state, source bundle, and end-to-end release prototype remain |
